						...
						<article class="card-body">
							<form action="cad.php" method="POST">
								...
								<div class="form-group">
									<label>CEP</label>
									<d id="cep">
										<input type="number" class="form-control" placeholder="CEP" name="cep" min="1" max="8"><span onclick="busca()"></span>
									</d>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" placeholder="Endereço e numero" name="end" disabled>
								</div> <!-- form-group end.// -->
								...
								<div class="form-row">
									<div class="form-group col-md-6">
										<label>Cidade</label>
										<input type="text" class="form-control" name="cid" disabled>
									</div> <!-- form-group end.// -->
									<div class="form-group col-md-6">
										<label>Estado</label>
										<input type="text" class="form-control" name="est" maxlength="2" disabled>
									</div> <!-- form-group end.// -->
								</div> <!-- form-row.// -->
								<div class="form-group">
									<label>Senha</label>
